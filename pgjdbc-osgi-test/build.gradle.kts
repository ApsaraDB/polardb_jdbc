val pgjdbcRepository by configurations.creating {
    ...
    description =
        "Consumes local maven repository directory that contains the artifacts produced by :polardb"
    attributes {
...
dependencies {
    pgjdbcRepository(project(":polardb"))

    testImplementation(project(":polardb"))
