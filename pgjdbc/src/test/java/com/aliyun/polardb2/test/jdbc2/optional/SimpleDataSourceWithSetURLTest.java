...
import static com.aliyun.polardb2.Driver.parseURL;
...
public class SimpleDataSourceWithSetURLTest extends BaseDataSourceTest {
  ...
  protected void initializeDataSource() {
    if (bds == null) {
      ...
      bds.setURL(String.format("jdbc:polardb://%s:%d/%s?prepareThreshold=%d", TestUtil.getServer(), TestUtil.getPort(), TestUtil.getDatabase(), TestUtil.getPrepareThreshold()));
