...
import com.aliyun.polardb2.jdbc2.optional.ConnectionPool;
...
public class ConnectionPoolTest extends BaseDataSourceTest {
  ...
  public void testStatementsProxyPGStatement() {
    try {
      ...
      Statement s = con.createStatement();
      boolean b = ((com.aliyun.polardb2.PGStatement) s).isUseServerPrepare();

      PreparedStatement ps = con.prepareStatement("select 'x'");
      b = ((com.aliyun.polardb2.PGStatement) ps).isUseServerPrepare();

      CallableStatement cs = con.prepareCall("select 'x'");
      b = ((com.aliyun.polardb2.PGStatement) cs).isUseServerPrepare();
