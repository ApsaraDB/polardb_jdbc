...
import com.aliyun.polardb2.jdbc2.optional.PoolingDataSource;
import com.aliyun.polardb2.jdbc2.optional.SimpleDataSource;
import com.aliyun.polardb2.osgi.PGDataSourceFactory;
import com.aliyun.polardb2.xa.PGXADataSource;
...
public class PGDataSourceFactoryTest {
  ...
  public void testCreateDriverDefault() throws Exception {
    ...
    Assert.assertTrue(driver instanceof com.aliyun.polardb2.Driver);
  }
