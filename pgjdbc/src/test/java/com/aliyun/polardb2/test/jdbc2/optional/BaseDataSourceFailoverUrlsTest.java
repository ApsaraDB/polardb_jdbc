...
public class BaseDataSourceFailoverUrlsTest {
  ...
  public void testFullDefault() throws ClassNotFoundException, NamingException, IOException {
    roundTripFromUrl("jdbc:polardb://server/database", "jdbc:polardb://server:" + DEFAULT_PORT + "/database");
  }

  @Test
  public void testTwoNoPorts() throws ClassNotFoundException, NamingException, IOException {
    roundTripFromUrl("jdbc:polardb://server1,server2/database", "jdbc:polardb://server1:" + DEFAULT_PORT + ",server2:" + DEFAULT_PORT + "/database");
  }

  @Test
  public void testTwoWithPorts() throws ClassNotFoundException, NamingException, IOException {
    roundTripFromUrl("jdbc:polardb://server1:1234,server2:2345/database", "jdbc:polardb://server1:1234,server2:2345/database");
  }

  @Test
  public void testTwoFirstPort() throws ClassNotFoundException, NamingException, IOException {
    roundTripFromUrl("jdbc:polardb://server1,server2:2345/database", "jdbc:polardb://server1:" + DEFAULT_PORT + ",server2:2345/database");
  }

  @Test
  public void testTwoLastPort() throws ClassNotFoundException, NamingException, IOException {
    roundTripFromUrl("jdbc:polardb://server1:2345,server2/database", "jdbc:polardb://server1:2345,server2:" + DEFAULT_PORT + "/database");
  }
  ...
  public void testNullPorts() {
    ...
    assertUrlWithoutParamsEquals("jdbc:polardb://localhost/database", bds.getURL());
