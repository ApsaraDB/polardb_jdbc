...
public class CompositeQueryParseTest {
  ...
  public void testHasReturning() throws SQLException {
    ...
    queries = Parser.parseJdbcSql("insert into foo (a,b,c) values (?,?,?)", true, true, false, true, true, false);
    query = queries.get(0);
  ...
  public void testSelect() throws SQLException {
    ...
    queries = Parser.parseJdbcSql("select 1 as returning from (update table)", true, true, false, true, true, false);
    NativeQuery query = queries.get(0);
  ...
  public void testMultiQueryWithBind() throws SQLException {
    ...
    List<NativeQuery> queries = Parser.parseJdbcSql(sql, true, true, true,true, true, false);
    NativeQuery query = queries.get(0);
  ...
  public void testMove() throws SQLException {
    List<NativeQuery> queries = Parser.parseJdbcSql("MoVe NEXT FROM FOO", true, true, false, true, true, false);
    NativeQuery query = queries.get(0);
  ...
  public void testUpdate() throws SQLException {
    List<NativeQuery> queries;
    NativeQuery query;
    queries = Parser.parseJdbcSql("update foo set (a=?,b=?,c=?)", true, true, false, true, true, false);
    query = queries.get(0);
  ...
  public void testInsert() throws SQLException {
    ...
    queries = Parser.parseJdbcSql("select 1 as insert", true, true, false, true, true, false);
    query = queries.get(0);
  ...
  public void testWithSelect() throws SQLException {
    List<NativeQuery> queries;
    queries = Parser.parseJdbcSql("with update as (update foo set (a=?,b=?,c=?)) select * from update", true, true, false, true, true, false);
    NativeQuery query = queries.get(0);
  ...
  public void testWithInsert() throws SQLException {
    List<NativeQuery> queries;
    queries = Parser.parseJdbcSql("with update as (update foo set (a=?,b=?,c=?)) insert into table(select) values(1)", true, true, false, true, true, false);
    NativeQuery query = queries.get(0);
  ...
  private String reparse(String query, boolean standardConformingStrings, boolean withParameters,
    ...
    try {
      return toString(
          Parser.parseJdbcSql(query, standardConformingStrings, withParameters, splitStatements, false, true, false));
