...
package com.aliyun.polardb2.fastpath;
...
public class Fastpath {
   ...
   * backend.</p>
   *
   * <p>For an example of how this works, refer to com.aliyun.polardb2.largeobject.LargeObject</p>
   *
   * @param name Function name
   * @param args FastpathArguments to pass to fastpath
   * @return null if no data, byte[] otherwise
   * @throws SQLException if name is unknown or if a database-access error occurs.
   * @see com.aliyun.polardb2.largeobject.LargeObject
   */
   ...
   *
   * <p>The com.aliyun.polardb2.largeobject.LargeObject class performs a query upon it's startup, and passes
   ...
   * @param rs ResultSet
   * @throws SQLException if a database-access error occurs.
   * @see com.aliyun.polardb2.largeobject.LargeObjectManager
   */
