...
import com.aliyun.polardb2.gss.GSSInputStream;
import com.aliyun.polardb2.gss.GSSOutputStream;
...
public class PGStream implements Closeable, Flushable {
   ...
   * @param hostSpec the host and port to connect to
   * @throws IOException if an IOException occurs below it.
   * @deprecated use {@link #PGStream(SocketFactory, com.aliyun.polardb2.util.HostSpec, int)}
   */
  @Deprecated
