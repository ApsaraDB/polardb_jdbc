 ...
 * @see com.aliyun.polardb2.ds.PGConnectionPoolDataSource
 */
      ...
      try {
        if (methodName.equals("createStatement")) {
          ...
          return Proxy.newProxyInstance(getClass().getClassLoader(),
              new Class[]{Statement.class, com.aliyun.polardb2.PGStatement.class},
              new StatementHandler(this, st));
        } else if (methodName.equals("prepareCall")) {
          Statement st = castNonNull((Statement) method.invoke(con, args));
          return Proxy.newProxyInstance(getClass().getClassLoader(),
              new Class[]{CallableStatement.class, com.aliyun.polardb2.PGStatement.class},
              new StatementHandler(this, st));
        } else if (methodName.equals("prepareStatement")) {
          Statement st = castNonNull((Statement) method.invoke(con, args));
          return Proxy.newProxyInstance(getClass().getClassLoader(),
              new Class[]{PreparedStatement.class, com.aliyun.polardb2.PGStatement.class},
              new StatementHandler(this, st));
        } else {
          return method.invoke(con, args);
        }
