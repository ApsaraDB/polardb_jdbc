...
import com.aliyun.polardb2.ds.PGConnectionPoolDataSource;
import com.aliyun.polardb2.ds.PGPoolingDataSource;
import com.aliyun.polardb2.ds.PGSimpleDataSource;
...
public class PGObjectFactory implements ObjectFactory {
  ...
  public @Nullable Object getObjectInstance(Object obj, Name name, Context nameCtx,
    ...
    if (className.equals("com.aliyun.polardb2.ds.PGSimpleDataSource")
        || className.equals("com.aliyun.polardb2.jdbc2.optional.SimpleDataSource")
        || className.equals("com.aliyun.polardb2.jdbc3.Jdbc3SimpleDataSource")) {
      return loadSimpleDataSource(ref);
    } else if (className.equals("com.aliyun.polardb2.ds.PGConnectionPoolDataSource")
        || className.equals("com.aliyun.polardb2.jdbc2.optional.ConnectionPool")
        || className.equals("com.aliyun.polardb2.jdbc3.Jdbc3ConnectionPool")) {
      return loadConnectionPool(ref);
    } else if (className.equals("com.aliyun.polardb2.ds.PGPoolingDataSource")
        || className.equals("com.aliyun.polardb2.jdbc2.optional.PoolingDataSource")
        || className.equals("com.aliyun.polardb2.jdbc3.Jdbc3PoolingDataSource")) {
