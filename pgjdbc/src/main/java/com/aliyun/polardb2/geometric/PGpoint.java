...
package com.aliyun.polardb2.geometric;
...
/**
 * <p>It maps to the point datatype in com.aliyun.polardb2.</p>
 *
...
public class PGpoint extends PGobject implements PGBinaryObject, Serializable, Cloneable {
  ...
  /**
   * @return the PGpoint in the syntax expected by com.aliyun.polardb2
   */
  ...
  /**
   * Populate the byte array with PGpoint in the binary syntax expected by com.aliyun.polardb2.
   */
